...
$string['uniquename_course'] = 'Nombre único';
$string['select_category'] = 'Seleccionar categoría';
$string['course_visible'] = 'Visible para los alumnos';
$string['uniquename_course_help'] = "Se utilizará este nombre, tanto para el nombre completo como para el nombre corto. (Debe ser único)";
