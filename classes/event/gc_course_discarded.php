...
/**
 * A pending import course was discarded.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gc_course_discarded extends base {
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' discarded the pending import of the " .
            "Google Classroom class '{$this->other['providerid']}'.";
    }
