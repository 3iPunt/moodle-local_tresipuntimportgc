...
use local_tresipuntimportgc\output\gc_desc_link_component;

/**
 * Class gc_mat_link_map
 *
 * @package     local_tresipuntimportgc
 * @copyright   2021 3iPunt (contacte@tresipunt.com)
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gc_mat_link_map extends gc_mat_map {
    ...
    public function get_render($mat): string {
        $component = new gc_desc_link_component($mat);
