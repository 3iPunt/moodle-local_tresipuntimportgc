...
$string['importfiles'] = 'Teacher folder';
$string['importfiles_help'] = 'What to do with the teacher\'s Google Drive folder of the class. This does not affect the files attached to the activities, which are always imported into their activity: it only governs the class folder, which can be linked from the course or copied to the private files area of the user who runs the import.';
$string['generategdlink'] = 'Download the teacher\'s Drive folder into a course folder, hidden from students';
...
$string['importindividual'] = 'Content assigned to individual students';
$string['importindividual_help'] = 'What to do with coursework, materials and announcements that in Classroom were assigned to specific students instead of the whole class.';
$string['importindividualhidden'] = 'Import hidden from students, with a note for the teacher';
$string['individual_note'] = 'Note for the teacher: in Google Classroom this content was assigned to specific students. It has been imported hidden from students.';
$string['googleformsimport'] = 'Google Forms';
$string['googleformsimport_help'] = 'What to do when a Classroom assignment consists of a single Google Form. This option applies to the whole site and cannot be changed per course. The form is currently embedded in a label; converting it into a Moodle quiz or feedback activity with its questions is planned for a future version.';
...
$string['course_room'] = 'Room: {$a}';
$string['announcement_title'] = 'Announcement';
$string['rubric_name'] = 'Rubric (imported from Google Classroom)';
...
$string['viewimports'] = 'View imports';
